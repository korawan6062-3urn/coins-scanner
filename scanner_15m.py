...
def get_candles(coin, interval="4h", limit=120):
    """ดึงข้อมูลกราฟ 4H / 15M พร้อมแปลงค่าตัวเลขสมบูรณ์"""
    try:
...
def check_15m_trigger(df_15m, trend_4h):
    """
    ตรวจจังหวะจบย่อ 15M ตามเกณฑ์ A.Aun:
    - BUY : Golden Cross ในโซน MACD น้อยกว่า 0
    - SELL: Death Cross ในโซน MACD มากกว่า 0
    """
    try:
...
def main():
    try:
        ...
        print(f"Fatal error in 15M main: {e}")
        traceback.print_exc()
